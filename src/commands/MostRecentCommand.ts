...
export default class MostRecentCommand extends Command implements ApplicationCommand {
    ...
    public async execute(interaction: CommandInteraction): Promise<void> {
        ...
        try {
            await fetch(`https://api.henrikdev.xyz/valorant/v1/lifetime/matches/${region}/${name}/${tag}?size=1&api_key=HDEV-04d0ed17-947a-49c0-871a-41ca3314250d`)
                ...
                .then(async res => {
                    ...
                    const embed: MessageEmbed = new MessageEmbed()
                        .setAuthor({name: `Recent Match: ${decodeURIComponent(name)}#${tag}`, iconURL: characterIcon})
